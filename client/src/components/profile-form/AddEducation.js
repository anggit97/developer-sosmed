...
const AddEducation = ({ addEducation, history }) => {
    ...
    return (
        <Fragment>
            ...
            <p className="lead">
                <i className="fas fa-code-branch"></i> Add any school or bootcamp that you already attended
      </p>
            ...
            <form className="form" onSubmit={e => onSubmit(e)}>
                ...
                <div className="form-group">
                    <p><input type="checkbox" name="current" check={current.toString()} value={current} onChange={e => {
